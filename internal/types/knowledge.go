...
type Knowledge struct {
	...
	// crash kills the worker. omitempty so old API consumers see the
	// exact pre-migration response shape for completed/idle rows.
