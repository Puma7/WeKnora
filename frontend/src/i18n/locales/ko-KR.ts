export default {
  ...
  auth: {
    ...
    registrationDisabled: "회원가입이 비활성화되어 있습니다. 관리자에게 문의하세요.",
    registrationByInviteOnly: "초대를 받은 경우에만 가입할 수 있습니다. 관리자에게 문의하세요.",
  },
  invitation: {
    title: "초대받으셨습니다",
    loading: "초대 정보를 불러오는 중...",
    invalidTitle: "유효하지 않은 초대",
    invalidMessage: "이 초대 링크는 유효하지 않거나 만료되었습니다.",
    missingToken: "초대 토큰이 없습니다",
    backToLogin: "로그인으로 돌아가기",
    fromAdmin: "관리자",
    invitedYou: "님이 가입을 초대했습니다.",
    tenantLabel: "테넌트",
    roleLabel: "역할",
    expiresAt: "만료",
    createAccount: "계정 생성 및 로그인",
  ...
  userManagement: {
    ...
    invite: {
      heading: "초대 보내기",
      emailPlaceholder: "초대받을 사람의 이메일",
      validityPlaceholder: "유효 기간 (일)",
      ...
      copied: "복사됨",
      created: "초대가 생성되었습니다",
      createFailed: "초대 생성 실패",
      listHeading: "초대 목록",
      noInvitations: "초대가 없습니다",
      expiresAt: "만료",
      revoke: "취소",
      status: { pending: "대기 중", accepted: "수락됨", revoked: "취소됨", expired: "만료됨" },
    },
    permissionsDialog: {
      title: "권한 재정의",
      hint: "각 플래그에서 \"기본값 사용\"을 선택하면 역할 기본값으로 돌아갑니다.",
      useDefault: "기본값 사용",
      allow: "허용",
      deny: "거부",
      flags: {
        can_chat: "채팅",
        can_search: "검색",
        can_create_kb: "지식베이스 생성",
        can_invite_users: "사용자 초대",
  ...
  kbPermissions: {
    menuItem: "사용자 권한",
    title: "지식베이스 사용자 권한",
    hint: "이 지식베이스에 대해 테넌트 사용자에게 개별 권한을 부여합니다.",
    orgShareNote: "참고: 조직 단위 공유는 별도로 관리되며 여기에는 표시되지 않습니다.",
    searchPlaceholder: "사용자명 또는 이메일로 검색",
    searchAction: "검색",
    searchResults: "검색 결과",
    grant: "부여",
    alreadyGranted: "이미 부여됨",
    currentGrants: "현재 권한",
    noGrants: "직접 부여된 사용자 권한이 없습니다",
    permissions: { viewer: "뷰어", editor: "편집자", admin: "관리자" },
    loadFailed: "불러오기 실패",
    searchFailed: "검색 실패",
    grantFailed: "권한 부여 실패",
    grantSucceededReload: "권한이 부여되었습니다. 목록이 새로고침되었습니다",
