...
/example\.(net|org)/`,
  ...
  retrievalSettings: {
    ...
    rrfKLabel: 'Сглаживающая константа RRF (k)',
    rrfKDescription: 'Сглаживающая константа реципрокного слияния рангов. Большие значения уменьшают смещение к верхним результатам (по умолчанию 60, рекомендуемый диапазон 30-100).',
    rrfVectorWeightLabel: 'Вес вектора в RRF',
    rrfVectorWeightDescription: 'Вес векторного поиска в слиянии RRF. Обычно сумма с весом ключевых слов равна 1,0 (по умолчанию 0,7).',
    rrfKeywordWeightLabel: 'Вес ключевых слов в RRF',
    rrfKeywordWeightDescription: 'Вес поиска по ключевым словам в слиянии RRF (по умолчанию 0,3).',
    toasts: {
  ...
  auth: {
    ...
    registrationDisabled: 'Регистрация отключена. Пожалуйста, свяжитесь с администратором.',
    registrationByInviteOnly: 'Регистрация только по приглашению. Пожалуйста, свяжитесь с администратором.'
  },
  invitation: {
    title: 'Вас пригласили',
    loading: 'Загрузка приглашения...',
    invalidTitle: 'Недействительное приглашение',
    invalidMessage: 'Эта ссылка-приглашение недействительна или истекла.',
    ...
    roleLabel: 'Роль',
    expiresAt: 'Истекает',
    createAccount: 'Создать аккаунт и войти',
    creatingAccount: 'Создание аккаунта...',
    welcome: 'Добро пожаловать!'
  },
  userManagement: {
    title: 'Пользователи и доступ',
    description: 'Управление пользователями, ролями, группами и приглашениями в вашем арендаторе.',
    loading: 'Загрузка...',
    ...
    updateFailed: 'Операция не выполнена',
    tabs: { users: 'Участники', invitations: 'Приглашения', roles: 'Роли', groups: 'Группы' },
    role: { owner: 'Владелец', admin: 'Администратор', member: 'Участник', viewer: 'Наблюдатель' },
    invite: {
      heading: 'Отправить приглашение',
      emailPlaceholder: 'Email приглашаемого',
      validityPlaceholder: 'Срок действия (дней)',
      ...
      expiresAt: 'Истекает',
      revoke: 'Отозвать',
      status: { pending: 'Ожидает', accepted: 'Принято', revoked: 'Отозвано', expired: 'Истекло' }
    },
    permissionsDialog: {
      title: 'Переопределить разрешения',
      hint: 'Выберите «По умолчанию», чтобы вернуться к настройкам роли.',
      ...
      flags: {
        can_chat: 'Чат',
        can_search: 'Поиск',
        can_create_kb: 'Создание баз знаний',
        can_invite_users: 'Приглашение пользователей',
        can_manage_users: 'Управление пользователями',
        can_manage_kbs: 'Управление базами знаний'
      }
    },
    roles: {
      heading: 'Роли и разрешения',
      description: 'Системные роли поставляются с продуктом и не редактируются. Пользовательские роли позволяют задать собственный набор разрешений для пользователей и групп.',
      empty: 'Пока нет пользовательских ролей. Создайте, чтобы настроить разрешения под ваш арендатор.',
      systemBadge: 'Системная',
      keyLabel: 'Ключ',
      keyPlaceholder: 'например, marketing_editor',
      labelLabel: 'Отображаемое имя',
      labelPlaceholder: 'например, Маркетинговый редактор',
      descriptionPlaceholder: 'Необязательное описание',
      createTitle: 'Создать пользовательскую роль',
      editTitle: 'Редактировать роль',
      create: 'Создать роль',
      created: 'Роль создана',
      updated: 'Роль обновлена',
      deleted: 'Роль удалена',
      deleteConfirm: 'Удалить роль «{label}»? Пользователей, использующих её, нужно сначала переназначить.',
      deleteInUse: 'Эта роль ещё используется {users} пользователем(-ями) и {groups} группой(-ами). Сначала переназначьте их.',
      lockedSystem: 'Системные роли нельзя изменять. Создайте пользовательскую роль, чтобы определить собственный набор разрешений.'
    },
    matrix: {
      title: 'Матрица разрешений',
      hint: 'Переключайте каждое разрешение, чтобы разрешить или запретить его для этой роли. Пустые ячейки используют системное значение по умолчанию.',
      useDefault: 'По умолчанию',
      allow: 'Разрешить',
      deny: 'Запретить',
      headers: { permission: 'Разрешение', value: 'Решение' }
    },
    groups: {
      heading: 'Группы пользователей',
      description: 'Группы объединяют пользователей и позволяют задать им базовую роль и точечные переопределения. Доступ к базам знаний, выданный группе, распространяется на всех её участников.',
      empty: 'Групп пока нет.',
      create: 'Создать группу',
      createTitle: 'Создать группу',
      editTitle: 'Редактировать группу',
      nameLabel: 'Название',
      namePlaceholder: 'например, marketing',
      descriptionPlaceholder: 'Необязательное описание',
      roleLabel: 'Базовая роль',
      noRole: 'Без переопределения роли',
      memberCount: 'Участников: {count}',
      members: 'Участники',
      addMember: 'Добавить участника',
      removeMember: 'Удалить',
      addMemberSearchPlaceholder: 'Поиск по email или имени...',
      created: 'Группа создана',
      updated: 'Группа обновлена',
      deleted: 'Группа удалена',
      deleteConfirm: 'Удалить группу «{name}»? Участники потеряют разрешения, выданные только этой группой.'
    }
  },
  permissions: {
    deniedDefault: 'У вас нет прав на это действие. Обратитесь к администратору.',
    flags: {
      chat: { label: 'Чат' },
      search: { label: 'Поиск' },
      create_kb: { label: 'Создание базы знаний' },
      invite_users: { label: 'Приглашение пользователей' },
      manage_users: { label: 'Управление пользователями и ролями' },
      manage_kbs: { label: 'Управление базами знаний' }
    },
    categories: {
  ...
  kbPermissions: {
    menuItem: 'Права пользователей',
    title: 'Права пользователей на базу знаний',
    hint: 'Назначьте отдельным пользователям арендатора доступ к этой базе знаний.',
    orgShareNote: 'Примечание: общие доступы на уровне организации управляются отдельно и здесь не отображаются.',
    searchPlaceholder: 'Поиск по имени или email',
    searchAction: 'Поиск',
    searchResults: 'Результаты',
    grant: 'Назначить',
    alreadyGranted: 'Уже назначено',
    currentGrants: 'Текущие назначения',
    noGrants: 'Нет прямых назначений пользователей',
    permissions: { viewer: 'Наблюдатель', editor: 'Редактор', admin: 'Администратор' },
    loadFailed: 'Не удалось загрузить',
    searchFailed: 'Поиск не удался',
    grantFailed: 'Не удалось назначить доступ',
    grantSucceededReload: 'Назначено; список обновлён',
