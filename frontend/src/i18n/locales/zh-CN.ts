export default {
  ...
  auth: {
    ...
    registrationByInviteOnly: "需要邀请才能注册，请联系管理员",
  },
  kbPermissions: {
    menuItem: "用户权限",
    title: "知识库用户权限",
    ...
    currentGrants: "当前授权",
    noGrants: "暂无用户被直接授权",
    permissions: { viewer: "查看者", editor: "编辑者", admin: "管理员" },
    loadFailed: "加载失败",
    searchFailed: "搜索失败",
    grantFailed: "授予失败",
    grantSucceededReload: "已授予，列表已刷新",
    updateFailed: "更新失败",
    revokeFailed: "撤销失败",
  },
  invitation: {
  ...
  userManagement: {
    ...
    invite: {
      heading: "发送邀请",
      emailPlaceholder: "邀请人邮箱",
      validityPlaceholder: "有效天数",
      ...
      expiresAt: "有效期至",
      revoke: "撤销",
      status: { pending: "待接受", accepted: "已接受", revoked: "已撤销", expired: "已过期" },
    },
    permissionsDialog: {
      title: "覆盖权限",
      hint: "选择 \"使用默认\" 以回退到角色的默认权限。",
      useDefault: "使用默认",
      allow: "允许",
      deny: "拒绝",
      flags: {
