export default {
  ...
  auth: {
    ...
    registrationDisabled: 'Registration is disabled. Please contact an administrator.',
    registrationByInviteOnly: 'Registration is by invitation only. Please contact an administrator.'
  },
  kbPermissions: {
    ...
    noGrants: 'No direct user grants yet',
    permissions: { viewer: 'Viewer', editor: 'Editor', admin: 'Admin' },
    loadFailed: 'Failed to load',
    searchFailed: 'Search failed',
    grantFailed: 'Failed to grant access',
    grantSucceededReload: 'Granted; the list has refreshed',
  ...
  userManagement: {
    ...
    invite: {
      ...
      emailPlaceholder: 'Invitee email',
      validityPlaceholder: 'Validity (days)',
      ...
      expiresAt: 'Expires',
      revoke: 'Revoke',
      status: { pending: 'Pending', accepted: 'Accepted', revoked: 'Revoked', expired: 'Expired' }
    },
    permissionsDialog: {
      title: 'Override permissions',
      hint: 'Pick "Use default" to fall back to the role default for any flag.',
      ...
      flags: {
        can_chat: 'Chat',
        can_search: 'Search',
        can_create_kb: 'Create knowledge bases',
